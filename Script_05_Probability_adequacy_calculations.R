##################################################################################################################################################################
##############          MICRO-POLL SCRIPT 5 - CALCULATING PROBABILITY OF ADEQUACY FROM NUTRIENT INTAKE DATA         ##############################################
##################################################################################################################################################################
...
process_and_save <- function(data, output_file) {
  ...
  #############################################################################################################################
  ########  Calculate usual intakes for each respondent (mean of all intakes across the year - justified with so many replicate records)
  #############################################################################################################################
...
#########################################################################################
###      Plot the change in PA for each res-cat and each nutrient  - Cleveland plot   #####
#########################################################################################
...
PA_summary_resp_cat_filter_1$scenario <- factor(PA_summary_resp_cat_filter_1$scenario, levels = c("no_poll","original","poll_incr" ))
levels(PA_summary_resp_cat_filter_1$scenario) <- c("No pollination", "Current pollination", "Optimum pollination" ) #Rename the factors

### Folate plot
Folate_Cleveland <- ggplot(PA_summary_resp_cat_filter_1 %>% filter(nutrient == "Folate"),
                      aes(x = prob_adeq,
                          y = fct_rev(factor(resp_cat, levels = names(custom_labels), labels = unname(custom_labels))),
                          color = scenario, shape = scenario, fill=scenario,
                          group = resp_cat)) +
  geom_line(color = "black", linewidth = 0.4) +
  geom_point(size = 2) +
  scale_color_manual(values = c("No pollination" = "#7C0A02", "Current pollination" = "black", "Optimum pollination" = "#6c905e"), name = "Scenario")+
  scale_fill_manual(values = c("No pollination" = "#7C0A02", "Current pollination" = "black", "Optimum pollination" = "#6c905e"), name = "Scenario")+
  scale_shape_manual(values = c("No pollination" = 16, "Current pollination" = 23, "Optimum pollination" = 17),name = "Scenario")+
  scale_x_continuous(limits = c(0, 1)) +
  labs(title = "Folate",x = "Probability of adequacy",y = NULL) +
...
### VitA plot
VitA_Cleveland <- ggplot(PA_summary_resp_cat_filter_1 %>% filter(nutrient == "VitA"),
                           aes(x = prob_adeq,
                               y = fct_rev(factor(resp_cat, levels = names(custom_labels), labels = unname(custom_labels))),
                               color = scenario, shape = scenario, fill=scenario,
                               group = resp_cat)) +
  ...
  labs(title = "Vitamin A",x = "Probability of adequacy",y = NULL) +
  theme_ipsum(base_size = 10) +
  theme(legend.position = "none")+
  theme(axis.title.x = element_text(size = 10, hjust = 0.5),
        plot.title = element_text(size = 12, face = "bold", hjust = 0))
...
### VitE plot
VitE_Cleveland <- ggplot(PA_summary_resp_cat_filter_1 %>% filter(nutrient == "VitE"),
                           aes(x = prob_adeq,
                               y = fct_rev(factor(resp_cat, levels = names(custom_labels), labels = unname(custom_labels))),
                               color = scenario, shape = scenario, fill=scenario,
                               group = resp_cat)) +
  ...
  labs(title = "Vitamin E",x = "Probability of adequacy",y = NULL) +
  theme_ipsum(base_size = 10) +
...
### VitC plot
VitC_Cleveland <- ggplot(PA_summary_resp_cat_filter_1 %>% filter(nutrient == "VitC"),
                           aes(x = prob_adeq,
                               y = fct_rev(factor(resp_cat, levels = names(custom_labels), labels = unname(custom_labels))),
                               color = scenario, shape = scenario, fill=scenario,
                               group = resp_cat)) +
  ...
  scale_shape_manual(values = c("No pollination" = 16, "Current pollination" = 23, "Optimum pollination" = 17),name = "Scenario")+
  scale_x_continuous(limits = c(0, 1)) +
  labs(title = "Vitamin C",x = "Probability of adequacy",y = NULL) +
  theme_ipsum(base_size = 10) +
  theme(legend.position = "none")+
  theme(axis.title.x = element_text(size = 10, hjust = 0.5),
        plot.title = element_text(size = 12, face = "bold", hjust = 0))
...
### iron plot
Iron_Cleveland <- ggplot(PA_summary_resp_cat_filter_1 %>% filter(nutrient == "iron"),
                           aes(x = prob_adeq,
                               y = fct_rev(factor(resp_cat, levels = names(custom_labels), labels = unname(custom_labels))),
                               color = scenario, shape = scenario, fill=scenario,
                               group = resp_cat)) +
  ...
  scale_shape_manual(values = c("No pollination" = 16, "Current pollination" = 23, "Optimum pollination" = 17),name = "Scenario")+
  scale_x_continuous(limits = c(0, 0.5)) +
  labs(title = "Iron",x = "Probability of adequacy",y = NULL) +
  theme_ipsum(base_size = 10) +
  theme(legend.position = "none")+
  theme(axis.title.x = element_text(size = 10, hjust = 0.5),
        plot.title = element_text(size = 12, face = "bold", hjust = 0))
...
### Calcium plot
Calcium_Cleveland <- ggplot(PA_summary_resp_cat_filter_1 %>% filter(nutrient == "Calcium"),
                           aes(x = prob_adeq,
                               y = fct_rev(factor(resp_cat, levels = names(custom_labels), labels = unname(custom_labels))),
                               color = scenario, shape = scenario, fill=scenario,
                               group = resp_cat)) +
  ...
  scale_shape_manual(values = c("No pollination" = 16, "Current pollination" = 23, "Optimum pollination" = 17),name = "Scenario")+
  scale_x_continuous(limits = c(0, 0.1)) +
  labs(title = "Calcium",x = "Probability of adequacy",y = NULL) +
  theme_ipsum(base_size = 10) +
  theme(legend.position = "none")+
  theme(axis.title.x = element_text(size = 10, hjust = 0.5),
        plot.title = element_text(size = 12, face = "bold", hjust = 0))
...
Cleveland_plot_with_legend <-
  (Folate_Cleveland + VitC_Cleveland + VitE_Cleveland + Iron_Cleveland + VitA_Cleveland + Calcium_Cleveland) +
...
ggsave(plot=Cleveland_plot_with_legend, filename="plots/Key_nutrients_PA_change_Cleveland.svg", width=7, height=7, dpi=600, bg="white")
ggsave(plot=Cleveland_plot_with_legend, filename="plots/Key_nutrients_PA_change_Cleveland.png", width=7, height=7, dpi=600, bg="white")
